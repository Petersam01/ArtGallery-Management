<%@ Page Title="" Language="C#" MasterPageFile="~/ArtGallery.Master" AutoEventWireup="true" CodeBehind="AnimalExhibitions.aspx.cs" Inherits="ArtGallary.AnimalExhibitions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <!--end of banner section-->
                    ...
                    <div class="col-12 text-center mt-4">
                        <div class="row my-6">
                            <div class="col-md-7 my-7">
                                <h2 class="text-left about"><b>About Animal Exhibition</b></h2>
      ...
      <h1 class="text-center" style="text-align: center;"><b>Animal exhibition line-up</b></h1>
    <div class="container">
        ...
        <div class="justify-content-center" style="margin-left: 45%;">
          <!--  <a href="RegNature.aspx" type="submit" class="btn btn-primary justify-content-center">Register for Exhibition</a> -->
