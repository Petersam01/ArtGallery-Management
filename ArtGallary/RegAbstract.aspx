<%@ Page Title="" Language="C#" MasterPageFile="~/ArtGallery.Master" AutoEventWireup="true" CodeBehind="RegAbstract.aspx.cs" Inherits="ArtGallary.RegAbstract" %>
    ...
    <div class="row justify-content-center">
        ...
        <form class="col-12">
          ...
          <div class="form-group">
              ...
              <input type="number" class="form-control" runat="server" id="number"  placeholder="Enter number of people attending" min="1" step="1" required />
           </div>
