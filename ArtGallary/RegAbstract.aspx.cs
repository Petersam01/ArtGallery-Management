...
{
    public partial class RegAbstract : System.Web.UI.Page
    {
        ...
        protected void Register_Click(object sender, EventArgs e)
        {
            if (int.TryParse(number.Value, out int numberOfPeople))
            {
                ...
                Booking newBooking = new Booking(name.Value, email.Value, phone.Value, DateTime.Now, numberOfPeople, "Abstract", password.Value);
