...
{
    public partial class NatureExhibitions : System.Web.UI.Page
    {
        ...
        public bool funcArtists()
        {
            ...
            foreach (Exhibition exhi in aga.GetArtistsByGenreNature())
            {
        ...
        protected void register_Click(object sender, EventArgs e)
        {
            ...
            if (exhibitionsExist)
            {
                ...
                Response.Redirect($"RegNature.aspx?EXHIBIT={iD}");
            }
            else
            {
        ...
        protected void delete_Click(object sender, EventArgs e)
        {
            ...
            //must change status to inactive and also remove all artist from the exhibition table with genre=nature
            string genre = "Nature";
            Exhibition exhibi = aga.GetArtistExhiByGenre(genre);
            string book = aga.GetBookingsByExhibitionName("Nature");
