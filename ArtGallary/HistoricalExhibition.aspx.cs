...
{
    public partial class HistoricalExhibition : System.Web.UI.Page
    {
        ...
        public bool funcArtists()
        {
            ...
            foreach (Exhibition exhi in aga.GetArtistsByGenreHistoric())
            {
        ...
        protected void register_Click(object sender, EventArgs e)
        {
            ...
            if (exhibitionsExist)
            {
                ...
                Response.Redirect($"RegHistoric.aspx?EXHIBIT={iD}");
            }
            else
            {
        ...
        protected void delete_Click(object sender, EventArgs e)
        {
            ...
            string genre = "Historic";
            Exhibition exhibi = aga.GetArtistExhiByGenre(genre);
            string book = aga.GetBookingsByExhibitionName("Historic");
