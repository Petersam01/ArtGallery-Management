<%@ Page Title="" Language="C#" MasterPageFile="~/ArtGallery.Master" AutoEventWireup="true" CodeBehind="AbstractExhibitions.aspx.cs" Inherits="ArtGallary.AbstractExhibitions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <!--end of banner section-->
                    ...
                    <div class="col-12 text-center mt-4">
                        <div class="row my-6">
                            <div class="col-md-7 my-7">
                                <h2 class="text-left about"><b>About Abstract Exhibition</b></h2>
      ...
      <h1 class="text-center" style="text-align: center;"><b>Abstract exhibition line-up</b></h1>
    <div class="container">
