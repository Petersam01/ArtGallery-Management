...
const RegAnimalScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.banner}>
        <Text style={styles.text}>Register for the Animal Exhibition</Text>
      </View>
      ...
      />
          ...
          <TextInput style={styles.txtInput} value="Animal" editable={false} />
...
export default RegAnimalScreen;
