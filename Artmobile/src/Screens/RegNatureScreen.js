...
const RegNatureScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.banner}>
        <Text style={styles.text}>Register for the Nature Art Exhibition</Text>
      </View>
      ...
      />
          ...
          <TextInput style={styles.txtInput} value="Nature" editable={false} />
...
export default RegNatureScreen;
