...
const RegAbstractScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.banner}>
        <Text style={styles.text}>Register for the Abstract Exhibition</Text>
      </View>
      ...
      />
          ...
          <TextInput style={styles.txtInput} value="Abstract" editable={false} />
...
export default RegAbstractScreen;
